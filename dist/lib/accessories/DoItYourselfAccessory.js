...
class DoItYourselfAccessory extends BaseAccessory_1.BaseAccessory {
            ...
            if (!body.success) {
                ...
                for (const code of this.accessory.context.device.codes) {
                    ...
                    service
                        ...
                        .onSet(async (value) => {
                        if (value) {
                            await this.sendLearningCode(this.accessory.context.device.ir_id, this.accessory.context.device.id, code.code);
    ...
    async sendLearningCode(deviceId, remoteId, code) {
